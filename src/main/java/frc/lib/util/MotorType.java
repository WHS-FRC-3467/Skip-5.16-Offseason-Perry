...
/**
 * Describes the performance attributes of various motors for use in diagnostics, sim, and
 * controls limits.
 */
public enum MotorType {
    KRAKEN_X60(NewtonMeters.of(7.05), Amps.of(366.0), RotationsPerSecond.of(100.0));

    private final Torque STALL_TORQUE;
    private final Current STALL_CURRENT;
    private final AngularVelocity FREE_SPEED;

    private MotorType(Torque STALL_TORQUE, Current STALL_CURRENT) {
