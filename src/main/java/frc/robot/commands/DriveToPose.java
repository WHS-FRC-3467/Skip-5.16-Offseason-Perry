...
public class DriveToPose extends Command {
    ...
    private static final LoggedTunableNumber defaultMaxVel =
    ...
    private Optional<LinearVelocity> maxVelocity = Optional.empty();
    ...
    public DriveToPose withMaxVelocity(LinearVelocity maxVelocity) {
    ...
    public void execute() {
        ...
        if (maxVelocity.isPresent()) {
            ...
            linearOutput = MathUtil.clamp(linearOutput, -defaultMaxVel.get(), defaultMaxVel.get());
        }
