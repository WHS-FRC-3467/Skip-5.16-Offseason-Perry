...
public class AutoFactory {
    private Drive drive;
    private IntakeSuperstructure intake;

    public AutoFactory(Drive drive, IntakeSuperstructure intake) {
        this.drive = drive;
        this.intake = intake;
    }
                ...
                Commands.sequence(
                        ...
                        Commands.parallel(
                                new DriveToPose(drive, () -> points.get(2))
                                        .withDistanceTolerance(Inches.of(20.0)),
                                intake.intake()),
                        ...
                        new DriveToPose(drive, () -> points.get(6))
                                .withDistanceTolerance(Inches.of(10.0))
                                .withMaxVelocity(MetersPerSecond.of(2.0)),
